      ...
      <div style={S.page} className="page-enter">
        <div style={{ ...S.card, textAlign: "center", padding: "40px 20px" }}>
          ...
          <p style={{ fontSize: 13, color: "#8892aa", lineHeight: 1.6 }}>
            ...
            <br />
            Streak maintained. Recovery is progress.
          </p>
        </div>
      </div>
    );
      ...
      {todayPlans.length === 0 ? (
        <div style={{ ...S.card, textAlign: "center", padding: "40px 20px" }}>
          ...
          <p style={{ fontSize: 13, color: "#8892aa" }}>
            Go to Plan tab to set up a workout for {todayDay}, or mark as rest
            day.
          </p>
        </div>
      ) : (
              ...
              <div style={S.planHeader}>
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "#8892aa", marginTop: 2 }}>
                    {done === total && total > 0
                      ? "Completed!"
                      : `${total - done} exercises remaining`}
                  </p>
                </div>
              ...
              {plan.exercises.map((ex) => {
                ...
                return (
                  <div
                    ...
                    <button
                      onClick={() => handleCheck(plan.id, ex.id)}
                      style={{
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                    ...
                    {ex.type === "cardio" ? (
                      <Timer
                        size={14}
                        style={{ color: "#8892aa", flexShrink: 0 }}
                      />
                    ) : (
                      <Dumbbell
                        size={14}
